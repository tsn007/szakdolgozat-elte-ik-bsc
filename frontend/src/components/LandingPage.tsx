                ...
                >
                    <Box>
                        ...
                        <Text size="xl" c="dimmed" lh={1.6} mb="xl" maw={500}>
                            Why buy what you only use once? Borrow tools, gear,
                ...
                >
                    ...
                    >
                        ...
                        <Text size="lg" c="dimmed">
                            ShareHood makes it safe and easy to share household
                            items, saving you money and reducing clutter.
                        </Text>
                    </Box>
                        ...
                        <Grid.Col span={{ base: 12, md: 6 }}>
                            <Box mb={48}>
                                ...
                                <Text size="lg" c="dimmed" maw={500}>
                                    Getting started with ShareHood takes less
                                    than 2 minutes.
                                </Text>
                            </Box>
